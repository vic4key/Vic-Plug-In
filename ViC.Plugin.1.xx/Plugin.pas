...
procedure AddToLog(addr: LongInt; highlight: Integer; format: PChar); cdecl; varargs;
...
function SaveIntCfg(dllinst: THandle; key: PChar; value: Integer): Integer; cdecl;

function SaveStrCfg(dllinst: THandle; key: PChar; s: PChar): Integer; cdecl;

function LoadIntCfg(dllinst: THandle; key: PChar; def: Integer): Integer; cdecl;

function LoadStrCfg(dllinst: THandle; key: PChar;
...
const OLLYDBG = 'OllyDbg.exe';

function  Addsorteddata; external OLLYDBG name '_Addsorteddata';
procedure AddToLog; external OLLYDBG name '_Addtolist';
...
function  LoadIntCfg; external OLLYDBG name '_Pluginreadintfromini';
function  LoadStrCfg; external OLLYDBG name '_Pluginreadstringfromini';
function  Pluginsaverecord; external OLLYDBG name '_Pluginsaverecord';
function  SaveIntCfg; external OLLYDBG name '_Pluginwriteinttoini';
function  SaveStrCfg; external OLLYDBG name '_Pluginwritestringtoini';
